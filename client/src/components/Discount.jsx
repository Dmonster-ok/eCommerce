    ...
    return (
        <section>
            <div className="container-lg">
                ...
                <div className="bg-secondary text-light py-5 my-5" style={{ backgroundImage: "url('src/assets/images/banner-newsletter.jpg')", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
